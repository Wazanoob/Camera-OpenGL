...
std::map<std::string, Mesh> AssetsManager::meshes;

Texture AssetsManager::loadTexture(IRenderer& renderer, const string& filename, const string& name)
{
...
Shader AssetsManager::loadShader(const std::string& vShaderFile, const std::string& fShaderFile, const std::string& tcShaderFile, const std::string& teShaderFile, const std::string& gShaderFile, const std::string& name)
{
...
Mesh AssetsManager::loadMesh(const string& filename, const string& name)
{
...
Texture AssetsManager::loadTextureFromFile(IRenderer& renderer, const string& filename)
{
    Texture texture;
...
Shader AssetsManager::loadShaderFromFile(const std::string& vShaderFile, const std::string& fShaderFile, const std::string& tcShaderFile, const std::string& teShaderFile, const std::string& gShaderFile)
{
...
Mesh AssetsManager::loadMeshFromFile(const string& filename)
{
    Mesh mesh;
